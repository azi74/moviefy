...
const SeriesCard = ({ title, image, year, genre, rating, seasons, onClick }: SeriesCardProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full aspect-[2/3] relative overflow-hidden">
        ...
        {/* Series Icon */}
        <div className="absolute top-4 left-4 bg-moviefy-yellow/90 text-moviefy-black p-2 rounded-full">
