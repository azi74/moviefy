...
const CompactSeriesCard = ({ title, image, year, genre, rating, seasons, onClick }: CompactSeriesCardProps) => {
      ...
      <div className="w-16 md:w-full md:aspect-[2/3] relative overflow-hidden flex-shrink-0">
        ...
        <img 
          ...
          onError={(e) => {
            ...
            target.src = `https://images.unsplash.com/photo-1594736797933-d0051ba2fe65?w=400&h=600&fit=crop`;
            setImageLoaded(true);
          }}
        />
        ...
        {/* Series Icon */}
        <div className="absolute top-1 left-1 md:top-4 md:left-4 bg-moviefy-yellow/90 text-moviefy-black p-1 md:p-2 rounded-full">
          <Tv className="h-2 w-2 md:h-4 md:w-4" />
        </div>
...
export default CompactSeriesCard;
