      ...
      <main className="container mx-auto px-6 pt-24 pb-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16 animate-fade-in">
            ...
            {/* Feature Cards - Minimalistic Design */}
            <div className="grid md:grid-cols-3 gap-4 mt-16">
              {featureCards.map((card, index) => (
                <div
                  key={index}
                  className="bg-moviefy-gray-dark/50 border border-moviefy-gray-medium/30 rounded-xl p-6 cursor-pointer hover:border-moviefy-yellow/50 hover:bg-moviefy-gray-dark/70 transition-all duration-300 group"
                  style={{ animationDelay: `${index * 0.1}s` }}
                >
                  <div className="flex flex-col items-center text-center space-y-3">
                    <div className="p-2 bg-moviefy-yellow/10 rounded-lg group-hover:bg-moviefy-yellow/20 transition-colors duration-300">
                      {card.icon}
                    </div>
